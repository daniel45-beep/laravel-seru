    ...
    <form action="{{route('education.update', $data->id)}}" method="POST">
        ...
        <div class="mb-3">
            <div class="row">
                ...
                <div class="col_auto"><input type="date" class="form-control form-control-sm" name="tgl_mulai" placeholder="dd/mm/yyy" value="{{$data->tgl_mulai}}"></div>
                <div class="col_auto">Tanggal Akhir</div>
                <div class="col_auto"><input type="date" class="form-control form-control-sm" name="tgl_akhir" placeholder="dd/mm/yyy" value="{{$data->tgl_akhir}}"></div>
            </div>
        </div>
