                ...
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <form onsubmit="return confirm('Yakin mau hapus data ini?')" action="<?php echo e(route('experience.destroy', $item->id)); ?>" class="d-inline" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-portofolio\resources\views/dashboard/experience/index.blade.php ENDPATH**/ ?>