    ...
    <form action="<?php echo e(route('education.store')); ?>" method="POST">
        ...
        <div class="mb-3">
            ...
            <input
                ...
                placeholder="Universitas" value="<?php echo e(Session::get('judul')); ?>"
            />
        </div>
        <div class="mb-3">
            ...
            <input
                ...
                id="info1"
                aria-describedby="helpId"
                placeholder="Nama Fakultas" value="<?php echo e(Session::get('info1')); ?>"
            />
        </div>
        <div class="mb-3">
            ...
            <input
                ...
                id="info2"
                aria-describedby="helpId"
                placeholder="Nama Prodi" value="<?php echo e(Session::get('info2')); ?>"
            />
        </div>
        <div class="mb-3">
            ...
            <input
                ...
                id="info3"
                aria-describedby="helpId"
                placeholder="IPK" value="<?php echo e(Session::get('info3')); ?>"
            />
        </div>
        <div class="mb-3">
            <div class="row">
...
<?php echo $__env->make('dashboard.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-portofolio\resources\views/dashboard/education/create.blade.php ENDPATH**/ ?>