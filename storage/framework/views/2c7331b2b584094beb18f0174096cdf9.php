        ...
        <div class="row justify-content-between">
            <div class="col-5">
                ...
                <?php if(get_meta_value('_foto')): ?>
                    <img style="max-width:100px;max-height:100px" src="<?php echo e(asset('foto')."/".get_meta_value('_foto')); ?>">
                <?php endif; ?>
                <div class="mb-3">
...
<?php echo $__env->make('dashboard.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-portofolio\resources\views/dashboard/profile/index.blade.php ENDPATH**/ ?>