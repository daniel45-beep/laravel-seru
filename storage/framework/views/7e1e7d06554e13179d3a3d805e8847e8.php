            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    ...
                    <div class="subheading mb-5">
                        <?php echo e(get_meta_value('_kota')); ?> · <?php echo e(get_meta_value('_provinsi')); ?> · <?php echo e(get_meta_value('_nohp')); ?> · <a href="<?php echo e(get_meta_value('_email')); ?>"><?php echo e(get_meta_value('_email')); ?></a>
                    </div>
                    <div class="lead mb-5"><?php echo $about->isi; ?></div>
...
<?php /**PATH C:\xampp3\htdocs\laravel-portofolio\resources\views/depan/index.blade.php ENDPATH**/ ?>